...
public class InputBuffer
{
    ...
    private float m_comboDelay = 0.75f;
    private float m_inputBufferingTime = 0.3f;
    ...
    public void AddInput(PlayerInput input)
    {
        ...
        m_signalBus.Fire(new OnInputBufferedSignal(input, false));
    }
    ...
    private void CheckBuffer()
    {
        ...
        {
            m_signalBus.Fire(new OnInputBufferedSignal(LastInput, true));
        }
    }
}
